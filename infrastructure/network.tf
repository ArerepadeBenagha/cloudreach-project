...
resource "aws_subnet" "main-public" {
  ...
  tags = merge(local.common_tags, { Name = "main-public", Company = "cloudreach" })
}
...
resource "aws_subnet" "main-public-1" {
  ...
  tags = merge(local.common_tags, { Name = "main-public-1", Company = "cloudreach" })
}
////subnet - private
...
resource "aws_route_table_association" "rtb-private-1" {
  ...
  route_table_id = aws_route_table.public-nat.id
}
...
resource "aws_nat_gateway" "cloureach-nat" {
  allocation_id = aws_eip.cloudreach-eip.id
  subnet_id     = aws_subnet.main-public.id
...
resource "aws_route_table" "public-nat" {
  ...
  tags = merge(local.common_tags, { Name = "public-nat", Company = "cloudreach" })
}